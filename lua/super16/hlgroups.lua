...
function M.setup(colors, config)
    ...
    local hlgroups = {
        ...
        NormalNC = config.dimInactive and { fg = colors.fg, bg = colors.bg_dim } or { link = "Normal" },
        ...
        NavicIconsFile = { fg = colors.fn, bg = colors.bg_status },
        NavicIconsModule = { fg = colors.pp, bg = colors.bg_status },
        NavicIconsNamespace = { fg = colors.pp, bg = colors.bg_status },
        NavicIconsPackage = { fg = colors.pp, bg = colors.bg_status },
        NavicIconsClass = { fg = colors.ty, bg = colors.bg_status },
        NavicIconsMethod = { fg = colors.fn, bg = colors.bg_status },
        NavicIconsProperty = { fg = colors.id, bg = colors.bg_status },
        NavicIconsField = { fg = colors.id, bg = colors.bg_status },
        NavicIconsConstructor = { fg = colors.kw, bg = colors.bg_status },
        NavicIconsEnum = { fg = colors.id, bg = colors.bg_status },
        NavicIconsInterface = { fg = colors.ty, bg = colors.bg_status },
        NavicIconsFunction = { fg = colors.fn, bg = colors.bg_status },
        NavicIconsVariable = { fg = colors.fg_dark, bg = colors.bg_status },
        NavicIconsConstant = { fg = colors.co, bg = colors.bg_status },
        NavicIconsString = { fg = colors.st, bg = colors.bg_status },
        NavicIconsNumber = { fg = colors.nu, bg = colors.bg_status },
        NavicIconsBoolean = { fg = colors.co, bg = colors.bg_status },
        NavicIconsArray = { fg = colors.co, bg = colors.bg_status },
        NavicIconsObject = { fg = colors.co, bg = colors.bg_status },
        NavicIconsKey = { fg = colors.kw, bg = colors.bg_status },
        NavicIconsNull = { fg = colors.co, bg = colors.bg_status },
        NavicIconsEnumMember = { fg = colors.id, bg = colors.bg_status },
        NavicIconsStruct = { fg = colors.ty, bg = colors.bg_status },
        NavicIconsEvent = { fg = colors.co, bg = colors.bg_status },
        NavicIconsOperator = { fg = colors.op, bg = colors.bg_status },
        NavicIconsTypeParameter = { fg = colors.id, bg = colors.bg_status },
        NavicText = { link = "StatusLine" },
